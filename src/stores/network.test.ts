...
describe('useNetworkStore', () => {
  ...
  describe('startNetwork', () => {
    it('should start network and update state', async () => {
      ...
      vi.mocked(networkService.getListeningAddresses).mockResolvedValue(['/ip4/0.0.0.0/tcp/9000']);
  ...
  describe('connectToPeer', () => {
    ...
    it('should throw on connection failure', async () => {
      vi.mocked(networkService.connectToPeer).mockRejectedValue(new Error('Connection failed'));
