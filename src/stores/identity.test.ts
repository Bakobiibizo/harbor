...
describe("useIdentityStore", () => {
  ...
  describe("initialize", () => {
    ...
    it("should handle errors gracefully", async () => {
      vi.mocked(identityService.hasIdentity).mockRejectedValue(
  ...
  describe("createIdentity", () => {
    ...
    it("should set error on failure", async () => {
      vi.mocked(identityService.createIdentity).mockRejectedValue(
  ...
  describe("unlock", () => {
    it("should unlock identity successfully", async () => {
      ...
      await useIdentityStore.getState().unlock("test123");
    ...
    it("should set error on wrong passphrase", async () => {
      vi.mocked(identityService.unlock).mockRejectedValue(
        new Error("Invalid passphrase")
      );

      await expect(
        useIdentityStore.getState().unlock("wrong")
